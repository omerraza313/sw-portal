        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="{{ url('admin/review')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  ...
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white">Daily Deals</div>
                  </div>
                  <!-- ./col -->
                </div>
                <!-- /.row -->
